...
export class RgtrRgntOfficerDetailsComponent {
  ...
  selectedOfficerToEdit: string = '';
  isEditableOfficer: boolean = false;
  validateEditUser(contactRole: string, isActive: boolean){
    if(this.selectedOrganisationId < 1){
      this.toastr.error('Please select a bank / organisation from dropdown to edit officers ');
      return;
    }
    console.log(contactRole);
    console.log(this.contactDetailsList);
    console.log(this.selectedOrganisationId);
    console.log(this.selectedOfficerToAdd);
    console.log(this.selectedOfficerToEdit);
    this.selectedOfficerToEdit = contactRole;
    this.selectedOfficerToAdd = this.selectedOfficerToEdit;
    this.isEditableOfficer = isActive;
  }
